<template>
    <div class="bmizhi-detail" v-loading="loading" ref="print">
        <el-page-header @back="goBack" content="详情页面"></el-page-header>
        <div class="admin-detail">
            <div class="detail detail-date">
                <div class="detail-title">日期：</div>
                <div class="detail-content">{{ map.riqi }}</div>
            </div>
            <div class="detail detail-money">
                <div class="detail-title">身高：</div>
                <div class="detail-content">{{ map.shengao }}</div>
            </div>
            <div class="detail detail-money">
                <div class="detail-title">体重：</div>
                <div class="detail-content">{{ map.tizhong }}</div>
            </div>
            <div class="detail detail-money">
                <div class="detail-title">BMI值：</div>
                <div class="detail-content">{{ map.bmizhi }}</div>
            </div>
