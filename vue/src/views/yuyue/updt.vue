<template>
    <div class="yuyue-add" v-loading="loading">
        <el-card class="box-card">
            <div slot="header" class="clearfix updt">
                <el-page-header @back="$router.go(-1)" content="编辑预约"> </el-page-header>
            </div>
            <div class="form-database-form">
                <el-form :model="form" ref="formModel" label-width="130px" status-icon validate-on-rule-change>
                    ...
                    <el-form-item label="预约时间" prop="yuyueshijian" required :rules="[{required:true, message:'请填写预约时间'}]">
                        <el-date-picker v-model="form.yuyueshijian" type="datetime" :editable="false" value-format="yyyy-MM-dd HH:mm:ss" placeholder="选择日期"> </el-date-picker>
                    </el-form-item>

                    <el-form-item label="预约人姓名" prop="yuyuerenxingming">
                        <el-input type="text" placeholder="输入预约人姓名" style="width: 250px" v-model="form.yuyuerenxingming" />
                    </el-form-item>

                    <el-form-item label="电话" prop="dianhua"> <el-input type="text" placeholder="输入电话" style="width: 250px" v-model="form.dianhua" /> </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            loadInfo() {
                ...
                this.loading = true;
                this.$store
                    .dispatch("yuyue/findById", this.id)
                    .then((res) => {
                        this.loading = false;
                        this.form = res;
                        formUtil.loadInfo(res.kechengid).then((rs) => {
