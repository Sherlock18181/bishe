<template>
    <div class="changguan-detail" v-loading="loading" ref="print">
        ...
        <div class="admin-detail">
            ...
            <div class="detail detail-longtext">
                <div class="detail-title">场馆名称：</div>
                <div class="detail-content">{{ map.changguanmingcheng }}</div>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            loadDetail() {
                ...
                this.loading = true;
                this.$store
                    .dispatch("changguan/findById", this.id)
                    .then((res) => {
                        this.loading = false;
                        this.map = res;
                    })
