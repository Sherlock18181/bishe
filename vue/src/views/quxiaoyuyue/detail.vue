<template>
    <div class="quxiaoyuyue-detail" v-loading="loading" ref="print">
        ...
        <div class="admin-detail">
            ...
            <div class="detail detail-readmodule">
                <div class="detail-title">课程id：</div>
                <div class="detail-content">{{ map.kechengid }}</div>
            </div>
            ...
            <div class="detail detail-text">
                <div class="detail-title">预约人姓名：</div>
                <div class="detail-content">{{ map.yuyuerenxingming }}</div>
            </div>
            <div class="detail detail-longtext">
                <div class="detail-title">课程名称：</div>
                <div class="detail-content">{{ map.kechengmingcheng }}</div>
            </div>
            <div class="detail detail-select">
                <div class="detail-title">类型：</div>
                <div class="detail-content">
                    <e-select-view module="kechengleixing" :value="map.leixing" select="id" show="leixingmingcheng"></e-select-view>
                </div>
            </div>
            ...
            <div class="detail detail-textuser">
                <div class="detail-title">取消人：</div>
                <div class="detail-content">{{ map.quxiaoren }}</div>
            </div>
            <div class="detail detail-textarea">
                <div class="detail-title">取消原因：</div>
                <div class="detail-content">{{ map.quxiaoyuanyin }}</div>
            </div>
        </div>
        <div class="mt10">
