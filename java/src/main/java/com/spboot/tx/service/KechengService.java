...
public class KechengService {
    ...
    public ResponseData<Kecheng> findById(Integer id) {
        return JsonResult.success(mapper.selectById(id));
    }

    public ResponseData<List<Kecheng>> selectAll(Wrapper<Kecheng> query) {
        return JsonResult.success(mapper.selectList(query));
    }

    public ResponseData<List<Kecheng>> selectAll() {
        QueryWrapper<Kecheng> wrapper = Wrappers.query();
    ...
    public ResponseData selectAll(Map<String, Object> map) {
        ...
        QueryWrapper<Kecheng> wrapper = mapToWrapper(map);
    ...
    public QueryWrapper<Kecheng> mapToWrapper(Map<String, Object> map) {
        QueryWrapper<Kecheng> wrapper = Wrappers.query();
     ...
     * @return 搜索到得数据
     */
    public ResponseData<List<Kecheng>> filter(Map<String, Object> map) {
        Class<Kecheng> aClass = Kecheng.class;
        com.jntoo.db.QueryWrapper<Kecheng> wrapper = DB.name(aClass);
    ...
    public ResponseData selectPages(QueryWrapper<Kecheng> wrapper, IPage page) {
        Map result = new HashMap();
        result.put("lists", mapper.selectPage(page, wrapper));
        return JsonResult.success(result);
    }

    public ResponseData insert(Kecheng entityData, Map post) {
    ...
    public ResponseData<Object> update(Kecheng entityData, Map post) {
