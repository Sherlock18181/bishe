...
@Service
public class KechengleixingService {

    @Resource
    private KechengleixingMapper mapper;

    public ResponseData<Kechengleixing> findById(Integer id) {
        return JsonResult.success(mapper.selectById(id));
    }

    public ResponseData<List<Kechengleixing>> selectAll(Wrapper<Kechengleixing> query) {
        return JsonResult.success(mapper.selectList(query));
    }

    public ResponseData<List<Kechengleixing>> selectAll() {
        QueryWrapper<Kechengleixing> wrapper = Wrappers.query();
    ...
    public ResponseData selectAll(Map<String, Object> map) {
        ...
        QueryWrapper<Kechengleixing> wrapper = mapToWrapper(map);
    ...
    public QueryWrapper<Kechengleixing> mapToWrapper(Map<String, Object> map) {
        QueryWrapper<Kechengleixing> wrapper = Wrappers.query();
     ...
     * @return 搜索到得数据
     */
    public ResponseData<List<Kechengleixing>> filter(Map<String, Object> map) {
        Class<Kechengleixing> aClass = Kechengleixing.class;
        com.jntoo.db.QueryWrapper<Kechengleixing> wrapper = DB.name(aClass);
    ...
    public ResponseData selectPages(QueryWrapper<Kechengleixing> wrapper, IPage page) {
        Map result = new HashMap();
        result.put("lists", mapper.selectPage(page, wrapper));
        return JsonResult.success(result);
    }

    public ResponseData insert(Kechengleixing entityData, Map post) {
    ...
    public ResponseData<Object> update(Kechengleixing entityData, Map post) {
