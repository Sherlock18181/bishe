...
@Service
public class ChangguanService {

    @Resource
    private ChangguanMapper mapper;

    public ResponseData<Changguan> findById(Integer id) {
        return JsonResult.success(mapper.selectById(id));
    }

    public ResponseData<List<Changguan>> selectAll(Wrapper<Changguan> query) {
        return JsonResult.success(mapper.selectList(query));
    }

    public ResponseData<List<Changguan>> selectAll() {
        QueryWrapper<Changguan> wrapper = Wrappers.query();
    ...
    public ResponseData selectAll(Map<String, Object> map) {
        ...
        QueryWrapper<Changguan> wrapper = mapToWrapper(map);
    ...
    public QueryWrapper<Changguan> mapToWrapper(Map<String, Object> map) {
        QueryWrapper<Changguan> wrapper = Wrappers.query();
        ...
        if (!StringUtil.isNullOrEmpty(map.get("changguanmingcheng"))) {
            wrapper.like("changguanmingcheng", map.get("changguanmingcheng"));
        }
     ...
     * @return 搜索到得数据
     */
    public ResponseData<List<Changguan>> filter(Map<String, Object> map) {
        Class<Changguan> aClass = Changguan.class;
        com.jntoo.db.QueryWrapper<Changguan> wrapper = DB.name(aClass);
    ...
    public ResponseData selectPages(QueryWrapper<Changguan> wrapper, IPage page) {
        Map result = new HashMap();
        result.put("lists", mapper.selectPage(page, wrapper));
        return JsonResult.success(result);
    }

    public ResponseData insert(Changguan entityData, Map post) {
    ...
    public ResponseData<Object> update(Changguan entityData, Map post) {
